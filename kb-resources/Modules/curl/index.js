...
//	if(isMac){
//		return DIRECTORY_PATH + 'MacOS/curl';
//	}
//	if(isLinux){
//		return DIRECTORY_PATH + 'Linux64/curl';
//	}
//	if(isWindows){
//		return DIRECTORY_PATH + 'Windows64/curl.exe';
//	}
//})();
var EXECUTABLE_PATH = "/usr/bin/curl";
...
exports.curl = function(command, stdIn){
	if(typeof command === 'string'){
		...
		return execute(EXECUTABLE_PATH, command, stdIn);
	}
}
