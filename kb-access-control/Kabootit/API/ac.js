...
// get permitted actions (via xhr except for this one place)
	...
	// TODO: sometimes this fails for no apparent reason
...
///// TO CREATE NEW API
//
// 1) Find/replace in this file 'AC' with whatever the API you are creating
 ...
 */
 AC.accessToken.push('1111');

/**
 * Whitelisted hosts
 */
// AC.accessHost.push('8.8.4.4');
...
/**
 * Pull in numbered versions (AC_v1.js, AC_v2.js, ..., AC_vn.js)
 */
init('AC',AC);
